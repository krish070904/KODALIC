  ...
  return (
    <div className="rounded-2xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#111528] p-5 shadow-sm dark:shadow-none transition-colors duration-200">
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-slate-100 dark:bg-white/[0.05] text-slate-500 dark:text-white/55">
          {icon}
        </div>
      </div>
      ...
      <div className="mx-auto max-w-7xl">
          ...
          <div className="mb-8">
            ...
            <div className="mt-2 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
              ...
              <div className="rounded-xl border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-white/[0.03] px-4 py-3 transition-colors duration-200">
                <p className="text-[10px] uppercase tracking-wider text-slate-400 dark:text-white/30">
                  Reporting period
                </p>

                <p className="mt-1 text-sm font-medium text-slate-700 dark:text-white/70">
                  Last 30 days
                </p>
              </div>
            </div>
          ...
          <section>
            <div className="mb-4 flex items-center gap-2">
              <Activity className="h-4 w-4 text-[#5b3df5] dark:text-[#a78bfa]" />
          ...
          <section className="mt-6 rounded-2xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#111528] shadow-sm dark:shadow-none transition-colors duration-200">
            <div className="border-b border-slate-200 dark:border-white/10 px-6 py-5">
              <div className="flex items-center gap-2">
                <FileText className="h-4 w-4 text-[#5b3df5] dark:text-[#a78bfa]" />
                      ...
                      <div className="flex items-center justify-between gap-6">
                        <div className="min-w-0 flex-1">
                          <div className="flex items-center gap-3">
                            <span className="w-5 text-xs text-slate-400 dark:text-white/25">
                              {index + 1}
                            </span>

                            <p className="truncate text-sm font-medium text-slate-700 dark:text-white/75">
                              {page.path}
                            </p>
                          </div>

                          <div className="mt-3 ml-8 h-1.5 overflow-hidden rounded-full bg-slate-200 dark:bg-white/[0.06]">
                            <div
                        ...
                        <p className="shrink-0 text-sm font-semibold text-slate-700 dark:text-white/70">
          ...
          {/* Data source */}
          <section className="mt-6 rounded-2xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#111528] px-6 py-5 shadow-sm dark:shadow-none transition-colors duration-200">
