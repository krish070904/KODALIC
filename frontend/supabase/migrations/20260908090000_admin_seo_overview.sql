...
BEGIN
    ...
    WITH registered_pages(entity_id, has_default_metadata) AS (
        VALUES
            ...
            ('00000000-0000-4000-8000-000000000009'::UUID, false),
            ('00000000-0000-4000-8000-000000000010'::UUID, false),
            ('00000000-0000-4000-8000-000000000011'::UUID, false),
            ('00000000-0000-4000-8000-000000000012'::UUID, false)
    )
    SELECT COUNT(*)
